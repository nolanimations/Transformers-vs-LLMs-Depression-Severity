...
|---|---|---|---|---|---|
| RoBERTa | 0.6788 | 0 | 0.08965 | 0.647 | Yes (local hardware) |
| MentalBERT | 0.6775 | 0 | 0.08989 | 0.649 | Yes (local hardware) |
...
- `est_co2_g_per_1k`: rough order-of-magnitude estimate only — 0.30 Wh / 1k tokens x 0.4 kg CO2/kWh (global grid average) for the LLMs; 250 W (GPU) / 65 W (CPU) assumed draw x measured wall time for the local encoders, depending on the benchmark device. Treat as comparable orders of magnitude, not precise figures.
